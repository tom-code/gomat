...
func MatterCert2(fabric *Fabric, in *x509.Certificate) []byte {
	...
	var tlv3 tlvenc.TLVBuffer
	tlv3.WriteAnonStruct()
	tlv3.WriteOctetString(1, in.SerialNumber.Bytes()) // serial number
	tlv3.WriteUInt(2, tlvenc.TYPE_UINT_1, 1) // signature algorithm
	...
	tlv3.WriteUInt(4, tlvenc.TYPE_UINT_4, uint64(in.NotBefore.Unix()-946684800))
	tlv3.WriteUInt(5, tlvenc.TYPE_UINT_4, uint64(in.NotAfter.Unix())-946684800)
	tlv3.WriteList(6)  // subject
		CAConvertDN(in.Subject, &tlv3)
	tlv3.WriteAnonStructEnd()
	tlv3.WriteUInt(7, tlvenc.TYPE_UINT_1, 1)
	tlv3.WriteUInt(8, tlvenc.TYPE_UINT_1, 1)
	//public key:
	...
	tlv3.WriteList(10)
		...
		tlv3.WriteUInt(2, tlvenc.TYPE_UINT_1, uint64(in.KeyUsage)) // key-usage
